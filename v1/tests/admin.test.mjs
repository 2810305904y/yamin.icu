...
test("project cards keep a slightly slimmer desktop footprint", async () => {
  ...
  assert.match(rootHtml, /\/v1\/styles\.css\?v=1\.5\.9-fine-data-fallback-85/);
  assert.match(rootHtml, /\/v1\/scripts\/render-site\.mjs\?v=1\.5\.9-fine-data-fallback-85/);
  ...
  assert.match(v1Html, /\.\/styles\.css\?v=1\.5\.9-fine-data-fallback-85/);
  assert.match(v1Html, /\.\/scripts\/render-site\.mjs\?v=1\.5\.9-fine-data-fallback-85/);
